...
```
## Context
You are working on Spovishun.
- Tech stack: kotlin | postgres | telegram | notion | docker
- See CLAUDE.md / AGENTS.md for architecture conventions, layering rules, DI strategy
- Source control conventions: branch prefix `feature/spovishun`, base branch `develop`
...
- See Spovishun repository CONVENTIONS.md / CLAUDE.md for any stack-specific constraints
```
