...
description: Use this agent when you need to research information on the internet — particularly for debugging Kotlin/Exposed/Coroutines/Telegram-bot edge cases via GitHub issues, Reddit r/Kotlin, Stack Overflow, and forums.
