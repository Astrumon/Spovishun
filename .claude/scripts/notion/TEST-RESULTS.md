...
|---|---|---|---|
| `notion-spovishun-task-manager` | "що в борді" | Runs `node .claude/scripts/notion/get-board.js`, returns board | ⬜ pending |
...
| `notion-task-to-code` | "зроби промпт для задачі #64" | Runs `node .claude/scripts/notion/get-task.js spovishun-64`, then `get-claude-md.js` | ⬜ pending |
