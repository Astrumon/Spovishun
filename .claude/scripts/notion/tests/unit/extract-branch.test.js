...
// extract-branch.js resolves the branch prefix at runtime via project-prefix.js
// (PROJECT_PREFIX env → config project.name → 'project'). Pin it here so these
// fixtures ("spovishun-42" → "feature/spovishun-…") are cwd-independent and do
// not depend on a config file being present at the test runner's working dir.
process.env.PROJECT_PREFIX = 'spovishun';
