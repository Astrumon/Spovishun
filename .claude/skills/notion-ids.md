# Notion Shared IDs — Spovishun

Single source of truth for IDs referenced across Notion skills.

| Resource | ID | Used by |
|---|---|---|
| Board collection (data source) | `3193462f-68a9-80b8-99b9-000bcbf3b536` | task-manager, task-to-code |
| Notion API DB ID | `3193462f68a980d69ec9c7ccc6329b88` | (raw DB ID, rarely needed directly) |
