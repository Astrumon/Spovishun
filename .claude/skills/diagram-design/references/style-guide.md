...
Default skin is a cool editorial palette — white-smoke paper, jet-black ink, kotlin-purple accent, blue-slate muted. It's designed to look good out of the box; swap these values (or run [`onboarding.md`](onboarding.md)) and every new diagram inherits the new skin without touching any type-specific logic.
