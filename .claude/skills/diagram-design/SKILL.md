---
name: diagram-design
description: Use this skill to generate editorial-quality technical diagrams as standalone HTML + inline SVG files for the Spovishun Telegram bot project — Clean Architecture layer diagrams, bot command flowcharts, user↔bot↔DB sequence diagrams, PostgreSQL/Exposed ER schemas, Flyway migration timelines, state machines for conversation flows, swimlanes for multi-actor scenarios, and more. Outputs save to docs/diagrams/ for git versioning. Triggers: "діаграма", "схема", "architecture diagram", "flowchart", "ER схема", "sequence diagram", "state machine", "swimlane", "Clean Architecture схема", "діаграма потоку", "схема БД", "намалюй діаграму", "побудуй схему".
license: MIT
metadata:
  version: "1.0"
---
