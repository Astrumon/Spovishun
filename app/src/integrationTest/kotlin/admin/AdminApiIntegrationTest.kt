...
class AdminApiIntegrationTest : BaseIntegrationTest() {
    ...
    private companion object {
        ...
        /**
         * Asks the OS for two ports — one for the server, one for the Docker URL to fail against.
         * The first socket stays open while the second is allocated, so the two cannot come back as
         * the same number and point the "dead" URL at the admin API itself.
         */
