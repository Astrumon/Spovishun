...
class RandomCommandIntegrationTest : BaseIntegrationTest() {
    @Test
    fun `random with only invoker registered should mention the invoker`() =
        runTest {
    ...
    @Test
    fun `random with registered members should mention one of them`() =
        runTest {
    ...
    @Test
    fun `random with nonexistent group should send group not found message`() =
        runTest {
