...
class MemberRepositoryImplTest {
    ...
    @Test
    fun `saveOrUpdate should create member and return it`() =
        runTest {
    ...
    @Test
    fun `saveOrUpdate should update username and firstName when called again with same userId`() =
        runTest {
    ...
    @Test
    fun `findByUsername should return member when exists`() =
        runTest {
            repository.saveOrUpdate(1L, "alice", "Alice")
    ...
    @Test
    fun `findByUserId should return member when exists`() =
        runTest {
    ...
    @Test
    fun `findById should return member when exists`() =
        runTest {
