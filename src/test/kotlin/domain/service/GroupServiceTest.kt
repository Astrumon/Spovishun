...
class GroupServiceTest {
    ...
    @Test
    fun `getAllGroupsWithMembers should return groups with members when successful`() =
        runTest {
            // Given
            val chatId = 123L
            val groups = listOf(
    ...
    @Test
    fun `getAllGroupsWithMembers should return empty list when no groups exist`() =
        runTest {
            // Given
            val chatId = 123L
    ...
    @Test
    fun `getAllGroupsWithMembers should propagate repository error`() =
        runTest {
            // Given
            val chatId = 123L
    ...
    @Test
    fun `createGroup should return success when repository succeeds`() =
        runTest {
            // Given
            val chatId = 123L
            val groupName = "devs"
    ...
    @Test
    fun `createGroup should propagate repository error`() =
        runTest {
            // Given
            val chatId = 123L
            val groupName = "devs"
    ...
    @Test
    fun `deleteGroup should return success when repository succeeds`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `deleteGroup should propagate repository error`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `addMemberToGroup should return success when repository succeeds`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `addMemberToGroup should propagate repository error`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `removeMemberFromGroup should return success when repository succeeds`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `removeMemberFromGroup should propagate repository error`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `getGroupByKey should return group with members when successful`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `getGroupByKey should propagate repository error when group not found`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
    ...
    @Test
    fun `getGroupByKey should propagate members repository error`() =
        runTest {
            // Given
            val chatId = 123L
            val groupKey = "devs"
