...
class MemberServiceTest {
    ...
    @Test
    fun `createMember should return success when user is new to this chat`() =
        runTest {
    ...
    @Test
    fun `createMember should return DuplicateResourceException when already in this chat`() =
        runTest {
            coEvery { memberRepository.saveOrUpdate(userId, username, firstName) } returns ResultContainer.success(member)
    ...
    @Test
    fun `createMember should propagate repository error`() =
        runTest {
    ...
    @Test
    fun `getMemberByUsername should return member when found`() =
        runTest {
    ...
    @Test
    fun `getMemberByUsername should return failure when not found`() =
        runTest {
    ...
    @Test
    fun `getMemberByUsername should propagate repository error`() =
        runTest {
            val error = DatabaseException("Database error")
    ...
    @Test
    fun `getMemberChatByUserId should return memberChat when found`() =
        runTest {
    ...
    @Test
    fun `getMemberChatByUserId should return failure when member not found`() =
        runTest {
    ...
    @Test
    fun `getMemberChatByUserId should return failure when not in this chat`() =
        runTest {
            coEvery { memberRepository.findByUserId(userId) } returns ResultContainer.success(member)
    ...
    @Test
    fun `setMemberRole should return updated memberChat on success`() =
        runTest {
    ...
    @Test
    fun `setMemberRole should return failure when member not found`() =
        runTest {
            coEvery { memberRepository.findByUserId(userId) } returns ResultContainer.success(null)
    ...
    @Test
    fun `updateMemberUsername should return same member when username unchanged`() =
        runTest {
            coEvery { memberRepository.findByUsername(username) } returns ResultContainer.success(member)
    ...
    @Test
    fun `updateMemberUsername should call saveOrUpdate when username changes`() =
        runTest {
    ...
    @Test
    fun `getMemberWithChatByUsername should return memberWithChat when found`() =
        runTest {
    ...
    @Test
    fun `getMemberWithChatByUsername should return failure when not found`() =
        runTest {
    ...
    @Test
    fun `getMemberWithChatByUsername should propagate repository error`() =
        runTest {
    ...
    @Test
    fun `getAllMembersInChat should return list via single JOIN query`() =
        runTest {
    ...
    @Test
    fun `getAllMembersInChat should return empty list when no members`() =
        runTest {
    ...
    @Test
    fun `hasAdminAccess should return true for ADMIN role`() =
        runTest {
    ...
    @Test
    fun `hasAdminAccess should return false for MEMBER role`() =
        runTest {
            coEvery { memberRepository.findByUserId(userId) } returns ResultContainer.success(member)
            coEvery { memberChatRepository.findByMemberIdAndChatId(memberId, chatId) } returns ResultContainer.success(memberChat)
    ...
    @Test
    fun `hasModeratorAccess should return true for MODERATOR role`() =
        runTest {
    ...
    @Test
    fun `hasModeratorAccess should return false when user not in chat`() =
        runTest {
            coEvery { memberRepository.findByUserId(userId) } returns ResultContainer.success(null)
