...
class ReleaseNotesServiceTest {
    ...
    @Test
    fun `getAll should parse version field`() =
        runTest {
    ...
    @Test
    fun `getAll should parse date field`() =
        runTest {
            val notes = service.getAll().getOrThrow()
    ...
    @Test
    fun `getAll should parse changes list`() =
        runTest {
            val notes = service.getAll().getOrThrow()
    ...
    @Test
    fun `getAll should return notes in newest-first order`() =
        runTest {
            val notes = service.getAll().getOrThrow()
    ...
    @Test
    fun `getAll should contain entry for current release`() =
        runTest {
            val notes = service.getAll().getOrThrow()
