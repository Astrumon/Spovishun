...
class BirthdayServiceTest {
    ...
    @Test
    fun `setBirthday should update and return member when found`() =
        runTest {
    ...
    @Test
    fun `setBirthday should return failure when member not found`() =
        runTest {
    ...
    @Test
    fun `setBirthdayForUsername should update birthday when username exists`() =
        runTest {
            val birthday = BirthDate(1, 1)
    ...
    @Test
    fun `setBirthdayForUsername should return failure when username not found`() =
        runTest {
    ...
    @Test
    fun `clearBirthday should call updateBirthday with null`() =
        runTest {
    ...
    @Test
    fun `getMembersWithBirthday should return members on given date`() =
        runTest {
            val birthday = BirthDate(25, 12)
    ...
    @Test
    fun `wasGreetedThisYear delegates to repository`() =
        runTest {
    ...
    @Test
    fun `recordGreetingSent delegates to repository`() =
        runTest {
    ...
    @Test
    fun `findChatIdsForMember should return chat ids from repository`() =
        runTest {
    ...
    @Test
    fun `findChatIdsForMember should propagate repository failure`() =
        runTest {
