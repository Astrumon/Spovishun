...
class MembersControllerTest {
    ...
    @Test
    fun `getMembers should pass userRole to ensureUserRegistered`() =
        runTest {
    ...
    @Test
    fun `getMembers should return Success with formatted list and role badges`() =
        runTest {
            val members = listOf(
    ...
    @Test
    fun `getMembers should show firstName for user_ prefixed usernames`() =
        runTest {
    ...
    @Test
    fun `getMembers should return Success with empty message when no members`() =
        runTest {
            coEvery { memberService.getAllMembersInChat(chatId) } returns ResultContainer.success(emptyList())
    ...
    @Test
    fun `getMembers should return Error on service failure`() =
        runTest {
    ...
    @Test
    fun `getMembers should pass ADMIN role to ensureUserRegistered when userRole is ADMIN`() =
        runTest {
