...
class RandomControllerTest {
    ...
    @Test
    fun `pickRandomAll should return Success with one of the registered members`() =
        runTest {
    ...
    @Test
    fun `pickRandomAll should return Success with the single member when list has one entry`() =
        runTest {
    ...
    @Test
    fun `pickRandomAll should return Success with no_registered message when list is empty`() =
        runTest {
    ...
    @Test
    fun `pickRandomAll should return Error when memberService fails`() =
        runTest {
    ...
    @Test
    fun `pickRandomFromGroup should return Success with one of the group members`() =
        runTest {
    ...
    @Test
    fun `pickRandomFromGroup should return Success with the single member when group has one entry`() =
        runTest {
    ...
    @Test
    fun `pickRandomFromGroup should return Success with empty_group message when group has no members`() =
        runTest {
    ...
    @Test
    fun `pickRandomFromGroup should return NotFound when group does not exist`() =
        runTest {
    ...
    @Test
    fun `pickRandomFromGroup should return NotFound with empty available when getAllGroupsWithMembers fails`() =
        runTest {
            coEvery { groupService.getGroupByKey(chatId, "ghost") } returns
                ResultContainer.failure(ResourceNotFoundException("Група", "ghost"))
            coEvery { groupService.getAllGroupsWithMembers(chatId) } returns
