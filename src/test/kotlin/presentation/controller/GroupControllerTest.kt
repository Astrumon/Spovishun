...
class GroupControllerTest {
    ...
    @Test
    fun `getGroups should return success with formatted list and badges`() =
        runTest {
    ...
    @Test
    fun `getGroups should handle member lookup failure gracefully`() =
        runTest {
    ...
    @Test
    fun `getGroups should return success with empty message when no groups`() =
        runTest {
    ...
    @Test
    fun `getGroups should return error on service failure`() =
        runTest {
    ...
    @Test
    fun `createGroup should return success when created`() =
        runTest {
    ...
    @Test
    fun `createGroup should return AccessDenied when caller is regular member`() =
        runTest {
    ...
    @Test
    fun `createGroup should return error when no args`() =
        runTest {
    ...
    @Test
    fun `createGroup should return error when group already exists`() =
        runTest {
    ...
    @Test
    fun `deleteGroup should return success when deleted`() =
        runTest {
    ...
    @Test
    fun `deleteGroup should return AccessDenied when caller is regular member`() =
        runTest {
            coEvery { memberService.hasModeratorAccess(chatId, userId) } returns false
    ...
    @Test
    fun `deleteGroup should return error when no args`() =
        runTest {
    ...
    @Test
    fun `deleteGroup should return NotFound when group does not exist`() =
        runTest {
    ...
    @Test
    fun `addUserToGroup should return success when user added`() =
        runTest {
    ...
    @Test
    fun `addUserToGroup should return AccessDenied when caller is regular member`() =
        runTest {
            coEvery { memberService.hasModeratorAccess(chatId, userId) } returns false
    ...
    @Test
    fun `addUserToGroup should return error when insufficient args`() =
        runTest {
    ...
    @Test
    fun `addUserToGroup should report not registered user in success message`() =
        runTest {
            val groupWithMembers = GroupWithMembers(1L, chatId, "devs", "devs", emptyList())
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.success(groupWithMembers)
    ...
    @Test
    fun `addUserToGroup should return NotFound when group does not exist`() =
        runTest {
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.failure(
                ResourceNotFoundException("Group", "devs"),
            )
    ...
    @Test
    fun `addUserToGroup should report already in group user in success message`() =
        runTest {
    ...
    @Test
    fun `addUserToGroup should handle multiple users with partial success`() =
        runTest {
            val groupWithMembers = GroupWithMembers(1L, chatId, "devs", "devs", emptyList())
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.success(groupWithMembers)
    ...
    @Test
    fun `removeUserFromGroup should return success when user removed`() =
        runTest {
            val groupWithMembers = GroupWithMembers(1L, chatId, "devs", "devs", listOf("bob"))
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.success(groupWithMembers)
    ...
    @Test
    fun `removeUserFromGroup should return AccessDenied when caller is regular member`() =
        runTest {
            coEvery { memberService.hasModeratorAccess(chatId, userId) } returns false
    ...
    @Test
    fun `removeUserFromGroup should return error when insufficient args`() =
        runTest {
    ...
    @Test
    fun `removeUserFromGroup should return NotFound when group does not exist`() =
        runTest {
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.failure(
                ResourceNotFoundException("Group", "devs"),
            )
    ...
    @Test
    fun `removeUserFromGroup should report not in group user in success message`() =
        runTest {
            val groupWithMembers = GroupWithMembers(1L, chatId, "devs", "devs", emptyList())
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.success(groupWithMembers)
    ...
    @Test
    fun `removeUserFromGroup should handle multiple users with partial success`() =
        runTest {
            val groupWithMembers = GroupWithMembers(1L, chatId, "devs", "devs", listOf("alice"))
            coEvery { groupService.getGroupByKey(chatId, "devs") } returns ResultContainer.success(groupWithMembers)
    ...
    @Test
    fun `grantRole should return success when admin grants moderator role`() =
        runTest {
    ...
    @Test
    fun `grantRole should return AccessDenied when caller is not admin`() =
        runTest {
    ...
    @Test
    fun `grantRole should report not found user in success message`() =
        runTest {
    ...
    @Test
    fun `grantRole should return error for invalid role name`() =
        runTest {
    ...
    @Test
    fun `grantRole should return error when insufficient args`() =
        runTest {
    ...
    @Test
    fun `grantRole should grant role to multiple users`() =
        runTest {
    ...
    @Test
    fun `grantRole should report partial failure when some users not found`() =
        runTest {
            val alice = Member(2L, 101L, "alice", "Alice")
            val aliceChat = MemberChat(2L, chatId, MemberRole.MEMBER, null)
            coEvery { memberService.getMemberByUsername("alice") } returns ResultContainer.success(alice)
