...
class GroupControllerHtmlEscapeTest {
    ...
    @Test
    fun `createGroup should escape HTML special chars in group name on success`() =
        runTest {
    ...
    @Test
    fun `createGroup should escape HTML special chars in duplicate error message`() =
        runTest {
            val maliciousName = "<b>hack</b>"
    ...
    @Test
    fun `deleteGroup should escape HTML in success message`() =
        runTest {
    ...
    @Test
    fun `grantRole should escape raw role arg in error message`() =
        runTest {
    ...
    @Test
    fun `createGroup should handle ampersand in group name`() =
        runTest {
    ...
    @Test
    fun `getGroups should escape group name and key`() =
        runTest {
