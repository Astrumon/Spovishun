...
class MemberChatRepositoryImpl : MemberChatRepository {
    override suspend fun findByMemberIdAndChatId(
        memberId: Long,
        chatId: Long,
    ): ResultContainer<MemberChat?> = safeDbQuery {
        MemberChats
            .selectAll()
    ...
    override suspend fun findAllByChatId(chatId: Long): ResultContainer<List<MemberChat>> = safeDbQuery {
        MemberChats
            .selectAll()
    ...
    override suspend fun existsByMemberIdAndChatId(
        memberId: Long,
        chatId: Long,
    ...
    override suspend fun findChatIdsByMemberId(memberId: Long): ResultContainer<List<Long>> = safeDbQuery {
        MemberChats
            .selectAll()
    ...
    private fun memberChatPredicate(
        memberId: Long,
        chatId: Long,
